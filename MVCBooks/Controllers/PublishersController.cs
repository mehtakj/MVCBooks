...
namespace MVCBooks.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(MVCBooksContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PublisherID,Name,StreetAddress,City,State,Zip")] Publisher publisher)
        {
